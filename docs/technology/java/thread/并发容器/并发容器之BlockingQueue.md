...
![BlockingQueue基本操作.png](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1240" height="132"></svg>)BlockingQueue基本操作.png
...
关于 ArrayBlockingQueue 的实现原理，可以[看这篇文章](https://juejin.im/post/6844903602448760845)。
...
![LinkedBlockingDeque的基本操作.png](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="600" height="263"></svg>)LinkedBlockingDeque的基本操作.png
...
![BlockingQueue和BlockingDeque的区别.png](https://user-gold-cdn.xitu.io/2018/5/6/163349267d5efe67?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)BlockingQueue和BlockingDeque的区别.png
...
来源于 https://juejin.cn/post/6844903602444582920