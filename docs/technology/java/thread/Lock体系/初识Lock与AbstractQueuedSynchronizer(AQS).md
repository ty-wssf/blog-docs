...
![concurrent目录结构.png](https://user-gold-cdn.xitu.io/2018/5/3/163260cff7a637f5?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)concurrent目录结构.png

其中包含了两个子包：atomic以及lock，另外在concurrent下的阻塞队列以及executors,这些就是concurrent包中的精华，之后会一一进行学习。而这些类的实现主要是依赖于volatile以及CAS（关于volatile可以看[这篇文章](https://juejin.im/post/6844903601064640525)，关于CAS可以看[这篇文章的3.1节](https://juejin.im/post/6844903600334831629)），从整体上来看concurrent包的整体实现图如下图所示：

![concurrent包实现整体示意图.png](https://gitee.com/wuyilong/picture-bed/raw/master/img/163260cff7cb847c.png)
...
![AQS可重写的方法.png](https://user-gold-cdn.xitu.io/2018/5/3/163260cff7d16b38?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)AQS可重写的方法.png

在实现同步组件时AQS提供的模板方法如下图：

![AQS提供的模板方法.png](https://user-gold-cdn.xitu.io/2018/5/3/163260cff87fe8bf?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)AQS提供的模板方法.png
...
![mutex的执行情况.png](https://user-gold-cdn.xitu.io/2018/5/3/163260cff934a80f?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)mutex的执行情况.png
...
总的来说，同步组件通过重写AQS的方法实现自己想要表达的同步语义，而AQS只需要同步组件表达的true和false即可，AQS会针对true和false不同的情况做不同的处理，至于底层实现，可以[看这篇文章](https://juejin.im/post/6844903601538596877)。


来源于 https://juejin.cn/post/6844903601534418958