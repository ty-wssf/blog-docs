...
Young GC日志:![img](https://gitee.com/wuyilong/picture-bed/raw/master/img/Young GC.png)

Full GC日志:![img](https://gitee.com/wuyilong/picture-bed/raw/master/img/Full GC.png)
...
![img](https://gitee.com/wuyilong/picture-bed/raw/master/img/g1.jpg)

- GC Pause Stats:可以查看GC 的次数、GC的时间、GC的开销、最大GC时间和最小GC时间等，以及相应的柱状图

![img](https://gitee.com/wuyilong/picture-bed/raw/master/img/g2.jpg)

- GC Pause Distribution:查看GC停顿的详细分布，x轴表示垃圾收集停顿时间，y轴表示是停顿次数。
- GC Timeline：显示整个时间线上的垃圾收集

![img](https://gitee.com/wuyilong/picture-bed/raw/master/img/g3.jpg)
...
![img](https://gitee.com/wuyilong/picture-bed/raw/master/img/gceasy1.png)

![img](https://gitee.com/wuyilong/picture-bed/raw/master/img/gceasy2.png)
